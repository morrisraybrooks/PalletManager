...
import com.dollargeneral.palletmanager.ui.screens.DatabaseViewerScreen
    ...
    NavHost(
        ...
        composable(PalletManagerRoutes.STATION_DATABASE) {
            StationDatabaseScreen(
                ...
                onNavigateToDbViewer = {
                    navController.navigate(PalletManagerRoutes.DATABASE_VIEWER)
                }
            )
        }

        // Database viewer screen - view database contents
        composable(PalletManagerRoutes.DATABASE_VIEWER) {
